...
$DKINST_WIN_SRC = 'https://github.com/bardiotmarin/MULTYBAND/raw/main/.resources/.scripts/install-docker-win.ps1'
### Docker installer script for Mac source link ##
$DKINST_MAC_SRC = 'https://github.com/bardiotmarin/MULTYBAND/raw/main/.resources/.scripts/install-docker-mac.ps1'
...
$PROJECT_BRANCH = "main"
$PROJECT_URL = "https://raw.githubusercontent.com/bardiotmarin/MultyBand/${PROJECT_BRANCH}"
...
function fn_checkDependencies() {
    colorprint "GREEN" "MultyBand AUTOMATIC GUIDED SETUP v$script:SCRIPT_VERSION"
