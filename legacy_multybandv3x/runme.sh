...
readonly PROJECT_URL="https://raw.githubusercontent.com/bardiotmarin/MultyBand/${PROJECT_BRANCH}"
...
fn_checkDependencies(){
    clear
    colorprint "GREEN" "MultyBand AUTOMATIC GUIDED SETUP v${SCRIPT_VERSION}"
    check_project_updates
    colorprint "GREEN" "---------------------------------------------- "
