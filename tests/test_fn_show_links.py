...
class TestFnShowLinks(unittest.TestCase):
    ...
    def test_fn_show_links(self, mock_input, mock_cls, mock_print):
            ...
            "apps": [
                {
                    ...
                    "link": "https://earnapp.com/i/8zp7aub",
                ...
                },
                {
                    ...
                    "link": "https://r.honeygain.me/BARDICEAC7",
                ...
                },
                {
                    ...
                    "link": "https://app.getgrass.io/register/?referralCode=ra6C9seOytc9eY0",
                    "image": "bardiotmarinain/grass",
                    "flags": {
                        "--email": {},
                        "--password": {}
                    }
            ...
            "extra-apps": [
                {
                    ...
                    "link": "https://mystnodes.co/?referral_code=eY6cj1t8sUv4bwgMbWqZSBNyzhB3jXITPrmR5HXC",
        ...
        self.assertIn("EARNAPP: https://earnapp.com/i/8zp7aub", clean_printed_output)
        self.assertIn("HONEYGAIN: https://r.honeygain.me/BARDICEAC7", clean_printed_output)
        self.assertIn("GRASS: https://app.getgrass.io/register/?referralCode=ra6C9seOytc9eY0", clean_printed_output)
        self.assertIn("---EXTRA-APPS---", clean_printed_output)
        self.assertIn("MYSTNODE: https://mystnodes.co/?referral_code=eY6cj1t8sUv4bwgMbWqZSBNyzhB3jXITPrmR5HXC", clean_printed_output)
