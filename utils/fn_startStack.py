...
def start_stack(compose_file: str = './docker-compose.yaml', env_file: str = './.env', instance_name: str = 'MULTYBAND', skip_questions: bool = False) -> bool:
    """
...
def start_all_stacks(main_compose_file: str = './docker-compose.yaml', main_env_file: str = './.env', main_instance_name: str = 'MULTYBAND', instances_dir: str = 'm4b_proxy_instances', skip_questions: bool = False) -> None:
    """
...
def main(app_config_path: str, m4b_config_path: str, user_config_path: str) -> None:
    try:
        ...
        base_instance_name = m4b_config.get('project', {}).get('compose_project_name', 'MULTYBAND')
