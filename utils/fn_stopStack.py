...
def stop_stack(compose_file: str = './docker-compose.yaml', instance_name: str = 'MULTYBAND', skip_questions: bool = False) -> bool:
    """
...
def stop_all_stacks(main_compose_file: str = './docker-compose.yaml', main_instance_name: str = 'MULTYBAND', instances_dir: str = 'm4b_proxy_instances', skip_questions: bool = False) -> None:
    """
